...
ventna = Tk()
ventna.title("Music Stream v0.1")
ventna.geometry("290x400")
...
def dowload():
     ...
     notification.notify(
        ...
        message = 'La descarga finalizo' + str(new_file),
        app_icon = '/sets/descargar.ico')

     
     #messagebox.showinfo('Completo', 'Descarga finalizada en: ' + str(new_file))
